...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 22, 2);
 	...
 	ivoc_help("help ?1 Gfluct2_original I:/SkyDrive/Nair Lab/Osci/LFP/single_cell/Gfluct.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("Gfluct2_original", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  oup();
 if(error){fprintf(stderr,"at line 154 in file Gfluct.mod:\n	SOLVE oup\n"); nrn_complain(_p); abort_run(error);}

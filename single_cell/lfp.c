...
#define lfp_line _p[1]
#define lfp_point _p[2]
#define lfp_rc _p[3]
#define initial_part_point _p[4]
#define _g _p[5]
#define transmembrane_current	*_ppvar[0]._pval
#define _p_transmembrane_current	_ppvar[0]._pval
#define initial_part_point	*_ppvar[1]._pval
#define _p_initial_part_point	_ppvar[1]._pval
#define initial_part_rc	*_ppvar[2]._pval
#define _p_initial_part_rc	_ppvar[2]._pval
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 6, 3);
 	...
 	ivoc_help("help ?1 lfp I:/SkyDrive/Nair Lab/Osci/LFP/single_cell/lfp.mod\n");

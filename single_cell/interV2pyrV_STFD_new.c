...
#define DA2 DA2_interV2pyrV_STFD
#define DA1 DA1_interV2pyrV_STFD
...
#define Beta2 Beta2_interV2pyrV_STFD
 double Beta2 = 0.0001;
#define Beta1 Beta1_interV2pyrV_STFD
 double Beta1 = 0.001;
#define DA_S DA_S_interV2pyrV_STFD
 double DA_S = 1.5;
#define DA_t3 DA_t3_interV2pyrV_STFD
 double DA_t3 = 1.15;
#define DA_t2 DA_t2_interV2pyrV_STFD
 double DA_t2 = 1.3;
#define DA_t1 DA_t1_interV2pyrV_STFD
 double DA_t1 = 0.8;
#define DAstop2 DAstop2_interV2pyrV_STFD
 double DAstop2 = 36000;
#define DAstart2 DAstart2_interV2pyrV_STFD
 double DAstart2 = 35900;
#define DAstop1 DAstop1_interV2pyrV_STFD
 double DAstop1 = 40000;
#define DAstart1 DAstart1_interV2pyrV_STFD
...
#define k k_interV2pyrV_STFD
 ...
 "Beta1_interV2pyrV_STFD", "/ms",
 "Beta2_interV2pyrV_STFD", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "DAstart1_interV2pyrV_STFD", &DAstart1_interV2pyrV_STFD,
 "DAstop1_interV2pyrV_STFD", &DAstop1_interV2pyrV_STFD,
 "DAstart2_interV2pyrV_STFD", &DAstart2_interV2pyrV_STFD,
 "DAstop2_interV2pyrV_STFD", &DAstop2_interV2pyrV_STFD,
 "DA_t1_interV2pyrV_STFD", &DA_t1_interV2pyrV_STFD,
 "DA_t2_interV2pyrV_STFD", &DA_t2_interV2pyrV_STFD,
 "DA_t3_interV2pyrV_STFD", &DA_t3_interV2pyrV_STFD,
 "DA_S_interV2pyrV_STFD", &DA_S_interV2pyrV_STFD,
 "Beta1_interV2pyrV_STFD", &Beta1_interV2pyrV_STFD,
 "Beta2_interV2pyrV_STFD", &Beta2_interV2pyrV_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _interV2pyrV_STFD_new_reg() {
	int _vectorized = 0;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interV2pyrV_STFD I:/SkyDrive/Nair Lab/Osci/LFP/single_cell/interV2pyrV_STFD_new.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 170 in file interV2pyrV_STFD_new.mod:\n	\n"); nrn_complain(_p); abort_run(error);}

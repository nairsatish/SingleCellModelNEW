...
extern Memb_func* memb_func;
 ...
 "setdata_xtraarray", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define LFP LFP_xtraarray
 double LFP[8];
#define is is_xtraarray
 double is = 0;
 ...
 "is_xtraarray", "milliamp",
 "LFP_xtraarray", "millivolts",
 "x_xtraarray", "1",
 "y_xtraarray", "1",
 "z_xtraarray", "1",
 "er_xtraarray", "microvolts",
 "rx_xtraarray", "megohm",
 "im_xtraarray", "milliamp/cm2",
 "ex_xtraarray", "millivolts",
 0,0
};
 static double v = 0;
 /* connect global user variables to hoc */
 static DoubScal hoc_scdoub[] = {
 "is_xtraarray", &is_xtraarray,
 0,0
};
 static DoubVec hoc_vdoub[] = {
 "LFP_xtraarray", LFP_xtraarray, 8,
 0,0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 19, 3);
 	...
 	ivoc_help("help ?1 xtraarray I:/SkyDrive/Nair Lab/Osci/LFP/single_cell/xtra_array.mod\n");
...
static void _modl_cleanup(){ _match_recurse=1;}
 ...
 static void _ba2(Node*_nd, double* _pp, Datum* _ppd, Datum* _thread, _NrnThread* _nt)  {
  ...
  v = NODEV(_nd);
 {int  _li ;for ( _li = 0 ; _li <= 8 - 1 ; _li ++ ) {
     er [ _li ] = ( 10.0 ) * rx [ _li ] * im * area ;
     LFP [ _li ] = LFP [ _li ] + er [ _li ] ;
     } }
   }
